...
namespace XCoin.API.Trader.XCoin.Trade
{
    /// <summary>
    ...
    public class XTradeApi
    {
        ...
        /// <param name="coin_name">BTC (기본값)</param>
        /// <param name="currency_name">KRW (기본값)</param>
        /// <param name="misu">신용거래(Y : 사용, N : 일반) – 추후 제공</param>
        /// <returns></returns>
        public async Task<TradePlace> Place(decimal units, decimal price, string type, string coin_name = "BTC", string currency_name = "KRW", string misu = "N")
        {
