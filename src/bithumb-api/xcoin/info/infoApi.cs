...
namespace XCoin.ApiCall.Trader.XCoin.Info
{
    ...
    public class XInfoApi
    {
        ...
        public async Task<UserBalance> GetUserBalance()
        {
            ...
            {
                _params.Add("order_currency", "BTC");
                _params.Add("payment_currency", "KRW");
            }
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<UserWalletAddress> GetWalletAddress()
        {
            var _params = new Dictionary<string, object>();
            {
                _params.Add("currency", "BTC");
            }
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<UserTicker> GetUserTicker()
        {
            var _params = new Dictionary<string, object>();
            {
                _params.Add("order_currency", "BTC");
